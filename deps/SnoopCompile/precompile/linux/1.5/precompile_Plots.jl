...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(plot!)),NamedTuple{(:annotation,),Tuple{Array{Tuple{Int64,Float64,PlotText},1}}},typeof(plot!),Plot{PlotlyBackend}})
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),Dict{Symbol,Any},Type{Val{:shape}},Plot{GRBackend}})
    ...
    Base.precompile(Tuple{typeof(get_series_color),Int64,Subplot{GRBackend},Int64,Symbol})
    ...
    Base.precompile(Tuple{typeof(ignorenan_extrema),Array{Float64,1}})
